...
--               V:/pueo_tv/bd/ps_base/ip/ps_base_adc0_clk_wiz_0/ps_base_adc0_clk_wiz_0_sim_netlist.vhdl
...
entity ps_base_adc0_clk_wiz_0_ps_base_adc0_clk_wiz_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of ps_base_adc0_clk_wiz_0_ps_base_adc0_clk_wiz_0_clk_wiz : entity is "ps_base_adc0_clk_wiz_0_clk_wiz";
end ps_base_adc0_clk_wiz_0_ps_base_adc0_clk_wiz_0_clk_wiz;

architecture STRUCTURE of ps_base_adc0_clk_wiz_0_ps_base_adc0_clk_wiz_0_clk_wiz is
  signal clk_in1_ps_base_adc0_clk_wiz_0 : STD_LOGIC;
  signal clk_out1_ps_base_adc0_clk_wiz_0 : STD_LOGIC;
  signal clk_out2_ps_base_adc0_clk_wiz_0 : STD_LOGIC;
  signal clk_out3_ps_base_adc0_clk_wiz_0 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ps_base_adc0_clk_wiz_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    clk_out3 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of ps_base_adc0_clk_wiz_0 : entity is true;
end ps_base_adc0_clk_wiz_0;

architecture STRUCTURE of ps_base_adc0_clk_wiz_0 is
begin
inst: entity work.ps_base_adc0_clk_wiz_0_ps_base_adc0_clk_wiz_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
